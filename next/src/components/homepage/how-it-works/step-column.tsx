        ...
        <div className="border-t-2 border-cw-ink pt-[18px]">
            <div className="flex justify-between items-baseline mb-[14px]">
                <div className="flex items-baseline gap-3">
                    <span className="font-poster text-[38px] leading-none text-cw-forest font-black">
                        {num}
                    </span>
                    <span className="font-italic-serif text-[28px] leading-none text-cw-clay font-medium italic">
                        {rn}
                    </span>
                </div>
                <svg
            ...
            <h3 className="m-0 mb-[10px] font-poster text-[22px] leading-[1.15] uppercase font-black">{t}</h3>
